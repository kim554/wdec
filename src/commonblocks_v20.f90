module pdotoutput
  ...
  real*8, dimension(2) :: period1, period2, savedperiod, litosave
  
end module pdotoutput
  
!****************************************************************************

module datain

  real*8, dimension(36) :: inputdata
...
! The following composition arrays are good to use in the pulsation code
  ...
  integer, parameter :: ndimo = 5
  real*8, dimension(ndimo,2) :: core_points
