...
!Common blocks
  ...
  real*8 :: best_sigma
  real*8, parameter :: tiny1 = 1.0d-2, tiny2 = 1.0-1
...
! This is for the oxygen profile
  ...
  core_points(3,2) = inputdata(21)/100. * core_points(2,2)
  core_points(4,1) = (inputdata(23)+inputdata(25)+inputdata(26))/100.
  core_points(4,2) = inputdata(22)/100. * core_points(3,2)
