...
contains
  ...
  subroutine istatco(pp2,tt2,iw,converg)
    ...
    if (.not. ios_new) then
       ...
       print *, "Error 9. This version of the code cannot use the MESA eos &
...
16  ot=(o-o2)/delta
    ...
    if (kap_new) then
       print *, "Error 10. This version of the code cannot use the MESA eos &
            tables. In controlparams, say 'N' to using MESA eos and & 
            opacities."
       print *, "If you want to use the MESA eos and opacities, compile the &
            MESA compatible version of the code (see Makefile)."
...
!!$          cif    = thermo_array(24)
       ...
       print *, "Error 7. This version of the code cannot use the MESA eos &
            tables. In controlparams, say 'N' to using MESA eos and & 
            opacities."
       print *, "If you want to use the MESA eos and opacities, compile the &
            MESA compatible version of the code (see Makefile)."
...
16  ot=(o-o2)/delta
    ...
    if (kap_new) then
       print *, "Error 8. This version of the code cannot use the MESA eos &
            tables. In controlparams, say 'N' to using MESA eos and & 
            opacities."
       print *, "If you want to use the MESA eos and opacities, compile the &
            MESA compatible version of the code (see Makefile)."
