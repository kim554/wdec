...
!Common blocks
    ...
    use vca
    use xbnd
    use xcompp, only : oxygenmass, carbonmass, heliummass
    use xxnew
...
!*************************************************
    if (evoloutput) then
       carbonfrac = carbonmass/(oxygenmass + carbonmass + heliummass)
...
161 format(i4,1p,e12.4,0p,f7.3,2f6.3,f7.3,f9.6,2f11.4,3f9.3,F11.4)
171 format(i4,1p,e12.4,0p,f7.3,2f6.3,f7.3,f9.6,2f11.4,2f9.3,F11.4)

       if ( ixswch .eq. 4 ) then
          write(11,161) modnr,ssg,p2,t2,ucent,rm,tel,bl,bnt,10.**amxc, &
               10.**amxo,sm_tmp,carbonfrac 
          write(9,161) modnr,ssg,p2,t2,ucent,rm,tel,bl,bnt,10.**amxc, &
               10.**amxo,sm_tmp,carbonfrac 
       else
          write(11,171) modnr,ssg,p2,t2,ucent,rm,tel,bl,bnt,10.**amxc,sm_tmp, &
               carbonfrac
          write(9,171) modnr,ssg,p2,t2,ucent,rm,tel,bl,bnt,10.**amxc,sm_tmp, &
               carbonfrac
          write(20,171) modnr,ssg,p2,t2,ucent,rm,tel,bl,bnt,10.**amxc,sm_tmp, &
               carbonfrac
       end if
