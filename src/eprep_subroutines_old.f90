...
!       end do
       ...
       if (.not. kap_new ) then
          ...
          print *, "Error 1. This version of the code cannot use the MESA eos &
               tables. In controlparams, say 'N' to using MESA eos and & 
               opacities."
          print *, "If you want to use the MESA eos and opacities, compile the &
               MESA compatible version of the code (see Makefile)."
          stop
       endif
...
987    continue
       ...
       if (.not. kap_new ) then
          ...
          print *, "Error 2. This version of the code cannot use the MESA eos &
               tables. In controlparams, say 'N' to using MESA eos and & 
               opacities."
          print *, "If you want to use the MESA eos and opacities, compile the &
               MESA compatible version of the code (see Makefile)."
...
987 continue
    ...
    if (.not. kap_new ) then
       ...
       print *, "Error 3. This version of the code cannot use the MESA eos &
            tables. In controlparams, say 'N' to using MESA eos and & 
            opacities."
       print *, "If you want to use the MESA eos and opacities, compile the &
            MESA compatible version of the code (see Makefile)."
...
!  call estate for each composition i for which x(i) ne 0.
    ...
    if (ios_new) then
       print *, "Error 4. This version of the code cannot use the MESA eos &
            tables. In controlparams, say 'N' to using MESA eos and opacities."
       print *, "If you want to use the MESA eos and opacities, compile the &
            MESA compatible version of the code (see Makefile)."
       stop
    else
...
706 return
  ...
  subroutine intg
    ...
    real*8, dimension(7) :: xavec
    real*8, parameter :: pecx_factor = 0.65 !scaling factor for convection
    integer :: newtime
    integer, pointer :: j
    ...
    do jx=2,4
       ...
       if (.not. kap_new ) then
          ...
          print *, "Error 5. This version of the code cannot use the MESA eos &
               tables. In controlparams, say 'N' to using MESA eos and & 
               opacities."
          print *, "If you want to use the MESA eos and opacities, compile the &
               MESA compatible version of the code (see Makefile)."
